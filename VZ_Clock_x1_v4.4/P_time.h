    ...
    <head>
        ...
        <script type = "text/javascript">
            function set_ntp(submit) {
                ...
                server += "&md_start=" + val('md_start') + "&md_stop=" + val('md_stop') + "&setTMes=" + val_sw('setTMes');
            ...
            function stop_alarm(submit) {
                server = "/stopalarm?stopAlarm=ok";
                send_request(submit,server);
            }
            function set_time(submit) {
                server = "/set_time?t0=" + val('t0') + "&t1=" + val('t1') + "&d0=" + val('d0') + "&d1=" + val('d1') + "&d2=" + val('d2');
                send_request(submit,server);
            }
        </script>
    </head>
    <body onload = "load('/configs_time');">
        ...
        <central-unit>
            ...
            <div id="main_unit">
                ...
                <br>
                <label class="switch"><span class="opt_cn">Наш час</span>
                    <input type="checkbox" id="setTMes">
                    <span class="switch-btn"></span>
                </label>
                <br>
                <br>
                ...
                <span class="save_booton" onclick="set_time(this);">Установить</span>
                <hr>
            </div>
            <div>

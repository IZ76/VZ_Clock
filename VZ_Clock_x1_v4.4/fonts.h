...
0x03, 0x3C, 0x42, 0x3C,     //0
0x03, 0x44, 0x7E, 0x40,     //1
0x03, 0x64, 0x52, 0x4C,     //2
0x03, 0x22, 0x4A, 0x34,     //3
0x03, 0x1E, 0x10, 0x7E,     //4
0x03, 0x2E, 0x4A, 0x32,     //5
0x03, 0x3C, 0x4A, 0x32,     //6
0x03, 0x62, 0x12, 0x0E,     //7
0x03, 0x34, 0x4A, 0x34,     //8
0x03, 0x4C, 0x52, 0x3C      //9
};
//==========================================
const uint8_t dig3x7[] PROGMEM = { 4,
0x03, 0x7C, 0x82, 0x7C,     //0
0x03, 0x84, 0xFE, 0x80,     //1
0x03, 0xE4, 0x92, 0x8C,     //2
0x03, 0x44, 0x92, 0x6C,     //3
0x03, 0x1E, 0x10, 0xFE,     //4
0x03, 0x4E, 0x8A, 0x72,     //5
0x03, 0x7C, 0x92, 0x64,     //6
0x03, 0xE2, 0x12, 0x0E,     //7
0x03, 0x6C, 0x92, 0x6C,     //8
0x03, 0x4C, 0x92, 0x7C      //9
};
//==========================================

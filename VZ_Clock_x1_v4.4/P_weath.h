...
<html>
    <head>
        ...
        <script type = "text/javascript">
            ...
            function set_nmon_on(submit) {
                server = "/nmonOn?nmonOn=" + val_sw("setNMonFound");
                send_request(submit, server);
            }
        </script>
    </head>
    <body onload = "load('/configs_weath');">
        ...
        <central-unit>
            ...
            <div id="main_unit">
                    <table class = "table">
                        <hr>
                        <label class="switch"><span class="opt_cn">Получать и выводить погоду на экран</span>
                    ...
                    <br>
                    <label class="switch"><span class="opt_cn">Отображать прогноз на сегодня</span>
                        <input type="checkbox" id="displayForecastToday">
                        <span class="switch-btn"></span>
                    </label>
                    <br>
                    <hr>
                    <label class="switch"><span class="opt_cn">Получать и выводить прогноз на завтра</span>
                ...
                <span class="center"><b>Установки NarodMon</b></span>
                  ...
                  <hr>
                  <label class="switch">
                      <span class="opt_cn">Использовать NarodMon сервер</span>
                      <input type="checkbox" class="checkbox" id="setNMonFound" name="switch-btn" onclick="set_nmon_on(this);">
                      <span class="switch-btn"></span>
                  </label>
                  <hr>
                  <table class = "table">
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="field" id="sensors_ID0" value="{{sensors_ID0}}" class="form-control" pattern="[0-9a-zA-Z.-]{1,32}"></td>
                    </tr>
                    <tr>
                        <td align = "right"><span class="opt_cn">Датчик 2</span></td>
                        <td><input type="text" class="field" id="sensors_ID1" value="{{sensors_ID1}}" class="form-control" pattern="[0-9a-zA-Z.-]{1,32}"></td>
                    </tr>
                    <tr>
                        <td align = "right"><span class="opt_cn">Датчик 3</span></td>
                        <td><input type="text" class="field" id="sensors_ID2" value="{{sensors_ID2}}" class="form-control" pattern="[0-9a-zA-Z.-]{1,32}"></td>
                    </tr>
                  </table>
                </center>
                <br>

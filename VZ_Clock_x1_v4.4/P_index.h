    ...
    <head>
        ...
        <script type = "text/javascript">
            function set_ssid(submit) {
                server = "/ssid?ssid0=" + val('ssid0') + "&password0=" + encodeURIComponent(val('password0')) + "&ssid1=" + val('ssid1') + "&password1=" + encodeURIComponent(val('password1'))+"&ssidAP=" + val('ssidap') + "&passwordAP=" + encodeURIComponent(val('passwordAp')) + "&auth=" + val('auth') + "&authOn=" + val_sw('authOn');
                    ...
                    <center>
                        <table id="table__font" class="table">
                            <tr>
                                ...
                                <td><span class="opt_cn"><b>SSID WiFi сети</b></span></td>
                                <td><span class="opt_cn"><b>Пароль</b></span></td>
                            </tr>
                            <tr>
                                <td align = "right"><span class="opt_cn">1</span></td>
                                <td><input type="text" class="field form-control" id="ssid0" value="{{ssid0}}" pattern="[-\w\s#@/]{1,15}" placeholder="name WiFi network"></td>
                            ...
                            <tr>  
                                ...
                                <td><input type="text" class="field form-control" id="ssid1" value="{{ssid1}}" pattern="[-\w\s#@/]{1,15}" placeholder="name WiFi network"></td>

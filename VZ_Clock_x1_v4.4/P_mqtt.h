    ...
    <head>
        ...
        <script type = "text/javascript">
            function set_mqtt_ust(submit) {
                ...
                server += "&mqtt_pub_sensor00=" + val('mqtt_pub_sensor00') + "&mqtt_pub_sensor01=" + val('mqtt_pub_sensor01') + "&mqtt_pub_sensor02=" + val('mqtt_pub_sensor02') + "&mqtt_pub_sensor03=" + val('mqtt_pub_sensor03') + "&mqtt_pub_sensor04=" + val('mqtt_pub_sensor04');
                server += "&mqtt_pub_tvoc=" + val('mqtt_pub_tvoc') + "&mqtt_pub_eco2=" + val('mqtt_pub_eco2');

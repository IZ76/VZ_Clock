...
<html>
    <head>
        ...
        <title>Часы информер VZ_Clock_x1_v4.1 (by IvanZah)</title>
        ...
        <script type = "text/javascript">
            function set_setup(submit) {
                ...
                server += "&sensorDom=" + val('sensorDom') + "&sensorUl=" + val('sensorUl') + "&sensorHome=" + val('sensorHome') + "&sensorHumi=" + val('sensorHumi') + "&sensorPrAl=" + val('sensorPrAl') + "&pressSys=" + val('pressSys') + "&clockNight=" + val_sw('clockNight') + "&buzzerSet=" + val_sw('buzzerSet') + "&timeOutMqtt=" + val('timeOutMqtt');
    ...
    <body onload = "load_setup();">
        <header>
            <span class="opt_cn">Часы информер VZ_Clock_x1_v4.1 (by IvanZah)</span><br>
        ...
        <central-unit>
            ...
            <div id="main_unit">
                <center>
                    ...
                    <table>
                         <tr>
                            <td align = "right"><span class="opt_cn">Уровень светодиода низ:</span></td>
                    ...
                    <br>
                    <span class="opt_cn">Таймаут данных с MQTT</span>

...
<html>
    <head>
        ...
        <title>Часы информер VZ_Clock_x2_v4.1 (by IvanZah)</title>
        ...
        <script type = "text/javascript">
            function set_setup(submit) {
                ...
                server += "&fontCLOCK=" + val('fontCLOCK') + "&fontSizeCLOCK=" + val('fontSizeCLOCK') + "&fontSizeData=" + val('fontSizeData') + "&dataDown=" + val('dataDown') + "&textDown=" + val('textDown') + "&displayData=" + val('displayData') + "&timeOutMqtt=" + val('timeOutMqtt');

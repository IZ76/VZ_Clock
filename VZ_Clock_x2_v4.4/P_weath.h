    ...
    <head>
        ...
        <script type = "text/javascript">
            ...
            function set_weather(submit) {
                server = "/weather?weatherKey0=" + val('weatherKey0') + "&weatherKey1=" + val('weatherKey1') +"&weatherHost=" + val('weatherHost') + "&cityID0=" + val('cityID0') + "&cityID1=" + val('cityID1') + "&weatherLang=" + val('weatherLang') + "&animNotWeather=" + val('animNotWeather');
                server += "&displayCityName=" + val_sw('displayCityName') + "&displayForecastNow=" + val_sw('displayForecastNow') + "&displayForecastToday=" + val_sw('displayForecastToday') + "&displayForecastTomorrow=" + val_sw('displayForecastTomorrow') + "&timeStartViewWeather=" + val('timeStartViewWeather') + "&timeEndViewWeather=" + val('timeEndViewWeather');
    ...
    <body onload = "load('/configs_weath');">
        ...
        <central-unit>
            ...
            <div id="main_unit">
                    ...
                    <br>
                    <label class="switch"><span class="opt_cn">Анимация ошибки прогноза</span>
                        <input type="checkbox" id="animNotWeather">
                        <span class="switch-btn"></span>
                    </label>
                    <br>
                  <center>
